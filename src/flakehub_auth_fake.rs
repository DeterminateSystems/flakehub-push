...
pub async fn get_fake_bearer_token(jwt_issuer_uri: &str, repository: &str, project_owner: &str, github_graphql_data_result: GithubGraphqlDataResult) -> Result<String> {
